...
namespace crea
{
	...
	public:
		UnalignedCollisionAvoidance(Entity* _entity, double radius, std::vector<Entity*>* entities, short _poids = 1)
			: Behaviour(_entity, _poids), m_radius(radius), m_entities(entities) { };
		Vector2f& Update(double _dT);
	};
